...
public class PbItemApplyInfo {
  ...
  public void setItemDepName(String itemDepName) {
    this.itemDepName = itemDepName;
  }
  ...
  public String getItemLeaderId() {
    return itemLeaderId;
  }

  public void setItemLeaderId(String itemLeaderId) {
    this.itemLeaderId = itemLeaderId;
  }
